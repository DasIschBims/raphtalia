            ...
            .addFields([
                {
                    ...
                    value: `> Name: **${interaction.guild.name}**
                            ...
                            > Creation date: <t:${Math.round(interaction.guild.createdTimestamp/1000)}>
                ...
                },
                {
                    ...
                    value: `> Total Channels: **${interaction.guild.channels.cache.size}**
                            ...
                            > Total Categories: **${interaction.guild.channels.cache.filter(c => c.type === "GUILD_CATEGORY").size}**
